...
const Bar = () => {
  ...
  >
      ...
      sx={{
        width: "65%",  height:60,background: 'white', borderRadius:3,boxShadow:3,marginTop:"1.5rem"
    }}>
        ...
        <Button variant='contained' sx={{ width :"25%", height:30,background: '#FF7900',fontSize:12, borderRadius: 1,marginTop:"1rem"}}> Find College</Button>
