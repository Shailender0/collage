                        ...
                        return (
                            <Box key={index} >
                                ...
                                <Typography sx={{
                                    ...
                                    lineHeight: '126.523%',
                                    paddingTop: '1rem'
                                }}>Assertion A: {statement1}</Typography>
                                <Typography sx={{
                                    fontFamily: "Poppins, sans-serif",
                                    color: '#2F1370',
                                    fontSize: '0.875rem',
                                    ...
                                    lineHeight: '126.523%',
                                    paddingTop: '1rem'
                                }} >Reason R: {statement2}</Typography>
                                <Grid container spacing={2} sx={{ display: 'flex', alignItems: 'center', paddingTop: '3rem', justifyContent: 'space-between' }} >
