...
// import Img1 from '../Hostel/images/pana.png';
...
const ApplySection = () => {
  return (
    ...
    flexDirection={"column"}>   
      ...
      <Button
        sx={{fontFamily: 'Poppins', backgroundColor: '#FF7900', color: '#ffffff', width: '300px', borderRadius: '12px', fontWeight: '600', fontStyle : 'bold', marginTop: '1rem', textTransform: 'capitalize'}}
