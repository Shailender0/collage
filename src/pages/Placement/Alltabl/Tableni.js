...
const rows = [
    createData("RPG Group", "INR 22 LPA", "Associate Manager", 10),
...
export default function Tableni() {
    return (
        <Container>
            <Box sx={{
                width: "1011px",
                ...
                <Typography sx={{
                    ...
                    IIM Bangalore General Management Placements
                </Typography>
                <Typography sx={{
                    fontFamily: "popins",
                    fontSize: '14px',
                    ...
                    The following table represents the General Management Placements for the batch 2021 at IIM Bangalore:                </Typography>
