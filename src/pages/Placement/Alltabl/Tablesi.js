...
const rows = [
    createData("Goldman Sachs", "INR 30-35 LPA", "Risk Analyst/Asset Management", 12),
        ...
        <Container>
            <Box sx={{
                ...
                <Typography sx={{
                    ...
                    IIM Bangalore Finance Sector Placements
                </Typography>
                <Typography sx={{
                    fontFamily: "popins",
                    fontSize: '14px',
                    ...
                    color: "#210366",
                    marginTop: "10px"
                }}>The following table represents the Finance sector placements for the batch 2021 at IIM Bangalore:
                </Typography>
