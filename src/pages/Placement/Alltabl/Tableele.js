        ...
        <Container>
            <Box sx={{
                ...
                <Typography sx={{
                    ...
                    IIM Bangalore Placements 2023 Company Wise
                </Typography>
                <Typography sx={{
                    fontFamily: "popins",
                    fontSize: '14px',
                    ...
                    The following table represents the sector wise placements for the batch 2023 at IIM Bangalore:
