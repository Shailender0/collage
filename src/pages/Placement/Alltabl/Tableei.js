...
const rows = [
    createData("Dr Reddy’s Laboratories", "INR 18-20 LPA", "Management Trainee", 5),
        ...
        <Container>
            <Box sx={{
                ...
                <Typography sx={{
                    ...
                    color: "#210366",
                    marginTop: "10px"
                }}>The following table represents the sales and marketing sector placements of batch 2021 at IIM Bangalore:
                </Typography>
