...
import rating from "./images/Group 28213.png";
import topCollegesCardIcon from "./images/Group 125.png";
import heartIcon from './images/HeartIcon.png';
import img1 from "./images/amico.png";
import img2 from "./images/rafiki.png";
import img3 from "./images/cuate.png";
import img4 from "./images/amico 1.png";
import img5 from "./images/pana.png";
import img6 from "./images/cuate 1.png";
import img7 from "./images/cuate 2.png";
import img8 from "./images/pana 1.png";
import img9 from "./images/rafiki 1.png";
import Acad1 from "./images/Acad1.png";
import Acad2 from "./images/Acad2.png";
import Acad3 from "./images/Acad3.png";
import Acad4 from "./images/Acad4.png";
import Acad5 from "./images/Acad5.png";
import Acad6 from "./images/Acad6.png";
import Acad7 from "./images/Acad7.png";
import Acad8 from "./images/Acad8.png";
import Acad9 from "./images/Acad9.png";
...
import exam4 from './images/exam4.png';
import exam5 from './images/exam5.png';
import exam6 from './images/exam6.png';
...
const FCCard = [
    ...
    },
    {
        img: fc2,
        id: "2",
        heading: "The University of British Columbia",
        subheading: "Vancouver, British Columbia",
        btn1: "Admissions",
        btn2: "Placements",
        btn3: "Add to Compare",
...
const topCollegesCard = [
    ...
    { 
      ...
      icon: topCollegesCardIcon,
      titles: "Software",
      contents: "Best Colleges for Nursing in Canada",
    ...
    icon: topCollegesCardIcon,
    titles: "M.Tech",
    contents: "Best Business School in Canada",
    ...
    icon: topCollegesCardIcon,
    titles: "BA",
    contents: "Top US-NEWS Ranked Colleges in Canada",
  ...
  },
    {
      ...
      icon: topCollegesCardIcon,
      titles: "BA",
      contents: "Top QS Ranked College in Canada",
    ...
    },
    {
      ...
      icon: topCollegesCardIcon,
      titles: "B.Sc",
      contents: "Best colleges for Law in Canada",
    ...
    },
    {
      ...
      icon: topCollegesCardIcon,
      titles: "BA",
      contents: "Best Aviation Colleges in Canada",
    ...
    },
    {
      ...
      icon: topCollegesCardIcon,
      titles: "B.Sc",
      contents: "Top CWUR Ranked Colleges in Canada",
...
const CollegeArticleData = [
    {
        ...
        date: "14 Feb 2023",
        icon: heartIcon,
        contents: "Study in Canada: Complete Guide for Indian Students...",
        contents_body: "Canada does not have any federal department or national system of education. It varies with every province of the country. There are more than 10,000 degree programs offered for students to study in Canada. At present, Canada has the highest number of graduates in the world.",
    ...
    },
    {
        ...
        date: "14 Feb 2023",
        icon: heartIcon,
        contents: "Higher Education in Canada: Types of Degrees, Colleges/Degrees, A...",
        contents_body: "Canada does not have any federal department or national system of education. It varies with every province of the country. There are more than 10,000 degree programs offered for students to study in Canada. At present, Canada has the highest number of graduates in the world..",
        content_link: "Read more"
    },
    {
        ...
        date: "14 Feb 2023",
        icon: heartIcon,
        contents: "Canadian Universities Ranking 2023- Top Universities and Subject.......",
        contents_body: "As per Canadian universities rankings for 2023, University of Toronto, McGill University and University of British Columbia once again aced and landed a position under 50 World Universities. The QS World University ........",
        content_link: "Read more"
    },
    {
        img: art4,
        date: "14 Feb 2023",
        icon: heartIcon,
        contents: "Increase in PGWP in Canada, Median Earning Rise for International...",
        contents_body: "As per the new Studies from Statistics Canada, the number of students attaining PGWP (Post Graduate Work Permit) have remarkably enhanced. With this, the annual median salary turned out to be twice in a decade. It has increased from $14,500 to $26,800 in 2008 and 2018 respectively.",
        content_link: "Read more"
    },
    {
        img: art5,
        date: "14 Feb 2023",
        icon: heartIcon,
        contents: "Canada Immigration Minister Highlights Initiatives to Immigration...",
        contents_body: "Canada's Immigration Minister Sean Fraser has revealed intentions to get the immigration system back on track, as he begins the new year by reassessing the actions needed to modernize the immigration and permanent residence procedures.",
        content_link: "Read more"
    },
    {
        img: art5,
        date: "14 Feb 2023",
        icon: heartIcon,
        contents: "Canada Still is Top Destination Amongst Prospective Immigrants; K...",
        contents_body: "According to a recent poll performed by World Education Services, Canada continues to be the",
        content_link: "Read more"
    },
];
...
const CollegeChooseData = [
    {
        img: c1,
        course: "Business",
        college: "1577 colleges"
    },
    {
        img: c2,
        course: "Science",
        college: "1369 colleges"
    },
    {
        img: c3,
        course: "Accounting",
    ...
    },
    {
        img: c4,
        course: "Finance",
        college: "1256 colleges"
    },
    {
        img: c5,
        course: "Humanities",
        college: "1424 colleges"
    },
    {
        img: c6,
        course: "Education",
...
const CollegeRankingData = [
    {
        img: p1,
        college: "University of Toronto - U of T",
        ranking: "1 out of 200",
        streams: "Overall"
    },
    {
        img: p2,
        college: "The University of British Columbia - UBC",
    ...
    {
        img: p4,
        college: "University of Montreal - U de M",
        ranking: "1 out of 50",
        streams: "Overall"
    },
    {
        img: p5,
        college: "University of Alberta - UAlberta",
        ranking: "1 out of 200",
        streams: "Overall"
    },
    {
        img: p6,
        college: "McMaster Univeristy",
        ranking: "1 out of 200",
        streams: "Overall"
    },
]

const PopularScholarshipData = [
    {
        heading: "Merit-Based",
...
const CanadaFAQsData = [
    {
        title: "Ques. What are the graduate admission requirements to study in Canada?",
        answer:
    ...
    {
        title: "Ques. What are the undergraduate admission requirements to study in Canada?",
        answer:
    ...
    {
        title: "Ques. What are the supporting documents required for admission to the graduate programs in Canada?",
        answer:
    ...
    {
        title: "Ques. What is the minimum GPA for admissions in Canada?",
        answer:
    ...
    {
        title: "Ques. Is IELTS required to study in Canada?",
        answer:
...
const ApplicationDatesData = [
    {
        img: p1,
        university: "M.S Management, University of Ottawa",
        events: "Application Deadline For Winter.......",
        start: "--",
        end: "Sep 1, 2023"
    },
    {
        img: p2,
        university: "M.S Biochemistry, University of Ottawa",
        events: "Application Deadline For Winter 2024 Intake........",
        start: "--",
        end: "Aug 1, 2023"
    },
    {
        img: p3,
        university: "M.S. Computer Science, University of Toronto",
    ...
    {
        img: p4,
        university: "M.S. Neuroscience, The University of British Columbia",
        events: "Application Deadline For Summer 2024.....",
        start: "--",
        end: "Dec 1, 2023"
    },
    {
        img: p5,
        university: "M.Eng Civil Engineering, McGill University",
        events: "Application Deadline For Fall 2024 Intake........",
        start: "--",
        end: "Aug 1, 2023"
    },
    {
        img: p1,
        university: "Application Deadline For Winter 2024 Intake",
        events: "Application Deadline For September 2024",
        start: "--",
        end: "May 1, 2023"
    },
]

export { FCCard, topCollegesCard, AcadCounsellor, TopPlacesData, CollegeArticleData, CollegeChooseData, CollegeRankingData, PopularScholarshipData, ExamsData, CanadaFAQsData, ApplicationDatesData };