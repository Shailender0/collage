...
<Box
        sx={{
          // height: `${show ? "fit-content" : "25.8rem"}`,
          // overflow: "hidden",
        ...
        <Typography
          id="review_haeding"
          sx={{ color: "#7B90FF",  fontFamily: "Poppins",
          fontSize: "16px",
          fontWeight: "700",
          letterSpacing: "0em", }}
        ...
        {reviews.map(({ heading, review }, index) => {
          return (
            <Box key={index} sx={{marginTop:"0.8rem",
            fontFamily: "Poppins",
          fontSize: "16px",
          fontWeight: "500",
          color: "#210366",
          letterSpacing: "0em",}}>
           ...
           &nbsp;{item} &nbsp;
                ...
                <Box sx={{ display: "flex", gap: "1rem", marginTop:"20px",
